...
for (let x = 0; x < orbField.childNodes.length; x++) {
  orbField.childNodes[x].style.background = 'var(--orb-inactive)'
}
...
play.addEventListener('click', () => {
  ...
  setTimeout(() => {
    ...
    for (let x = 0; x < orbCount; x++) {
      orbField.childNodes[x].style.background = 'var(--orb-active)'
    }
